...
def process_context_for_richtext(context_data: dict) -> dict:
    ...
    for key, value in context_data.items():
        ...
        if key in ("SUMMARY","RESPONSIBILITES_AL", "RESPONSIBILITES_ZB", "RESPONSIBILITES_SM") and isinstance(value, list):
            processed_list = []
            for item in value:
